...
with gzip.open('../../sources/super_cluster_CGOs/SC01_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_001')
cmd.set('cgo_line_width', 5, 'cluster_001')

with gzip.open('../../sources/super_cluster_CGOs/SC02_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_002')
cmd.set('cgo_line_width', 5, 'cluster_002')

with gzip.open('../../sources/super_cluster_CGOs/SC03_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_003')
cmd.set('cgo_line_width', 5, 'cluster_003')

with gzip.open('../../sources/super_cluster_CGOs/SC04_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_004')
cmd.set('cgo_line_width', 5, 'cluster_004')

with gzip.open('../../sources/super_cluster_CGOs/SC05_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_005')
cmd.set('cgo_line_width', 5, 'cluster_005')

with gzip.open('../../sources/super_cluster_CGOs/SC07_md1_pathset2.dump.gz', 'rb') as in_stream:
    pathset = pickle.load(in_stream)
