...
def _convert_msms_to_cgo(meshfile: str, color_id: Union[int, None]) -> List[float]:
    """
...
def msms_surface(msms_binary_path: str, spheres: List[Tuple[np.array, float]], color_id: Union[int, None],
