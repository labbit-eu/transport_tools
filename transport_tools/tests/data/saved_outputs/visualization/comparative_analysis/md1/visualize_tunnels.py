...
with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC01_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_001')
cmd.set('cgo_line_width', 5, 'cluster_001')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC02_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_002')
cmd.set('cgo_line_width', 5, 'cluster_002')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC03_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_003')
cmd.set('cgo_line_width', 5, 'cluster_003')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC04_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_004')
cmd.set('cgo_line_width', 5, 'cluster_004')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC05_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_005')
cmd.set('cgo_line_width', 5, 'cluster_005')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC06_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
...
with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC13_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
...
with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC15_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_015')
cmd.set('cgo_line_width', 5, 'cluster_015')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC16_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_016')
cmd.set('cgo_line_width', 5, 'cluster_016')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC17_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_017')
cmd.set('cgo_line_width', 5, 'cluster_017')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC18_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_018')
cmd.set('cgo_line_width', 5, 'cluster_018')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC19_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_019')
cmd.set('cgo_line_width', 5, 'cluster_019')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC20_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_020')
cmd.set('cgo_line_width', 5, 'cluster_020')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC21_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_021')
cmd.set('cgo_line_width', 5, 'cluster_021')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC22_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_022')
cmd.set('cgo_line_width', 5, 'cluster_022')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC23_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_023')
cmd.set('cgo_line_width', 5, 'cluster_023')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC24_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_024')
cmd.set('cgo_line_width', 5, 'cluster_024')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC25_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_025')
cmd.set('cgo_line_width', 5, 'cluster_025')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC26_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
cmd.load_cgo(pathset, 'cluster_026')
cmd.set('cgo_line_width', 5, 'cluster_026')

with gzip.open(os.path.join('..', '..', 'sources', 'super_cluster_CGOs', 'SC27_md1_pathset1.dump.gz'), 'rb') as in_stream:
    pathset = pickle.load(in_stream)
