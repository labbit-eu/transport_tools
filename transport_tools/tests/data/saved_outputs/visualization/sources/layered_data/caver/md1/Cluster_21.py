...
cmd.load('nodes/cls021-7-0.pdb')
cmd.set_color('caver8', [0.99, 0.5, 0.42])
cmd.color('8', "cls021-7-0")
...
cmd.load('nodes/cls021-7-9.pdb')
cmd.set_color('caver8', [0.99, 0.5, 0.42])
cmd.color('8', "cls021-7-9")
cmd.load('nodes/cls021-7-10.pdb')
cmd.set_color('caver8', [0.99, 0.5, 0.42])
cmd.color('8', "cls021-7-10")
...
cmd.load('nodes/cls021-8-4.pdb')
cmd.set_color('caver9', [0.21, 0.5, 0.85])
cmd.color('9', "cls021-8-4")
...
cmd.load('nodes/cls021-10-4.pdb')
cmd.set_color('caver11', [0.0, 0.87, 0.5])
cmd.color('11', "cls021-10-4")
...
cmd.load('nodes/cls021-12-6.pdb')
cmd.set_color('caver13', [0.58, 0.82, 0.0])
cmd.color('13', "cls021-12-6")
